...
#define OffsetControllerImageX(x_loc) ((x_loc) + 356)
#define OffsetControllerImageY(y_loc) ((y_loc) + 267)
...
static struct
{
    ...
    {OffsetControllerImageX(480), OffsetControllerImageY(147), 0.0, MARKER_BUTTON}, /* SDL_CONTROLLER_BUTTON_A */
    {OffsetControllerImageX(431), OffsetControllerImageY(188), 0.0, MARKER_BUTTON}, /* SDL_CONTROLLER_BUTTON_B */
    {OffsetControllerImageX(387), OffsetControllerImageY(151), 0.0, MARKER_BUTTON}, /* SDL_CONTROLLER_BUTTON_X */
    {OffsetControllerImageX(436), OffsetControllerImageY(112), 0.0, MARKER_BUTTON}, /* SDL_CONTROLLER_BUTTON_Y */
    {OffsetControllerImageX(197), OffsetControllerImageY(153), 0.0, MARKER_BUTTON}, /* SDL_CONTROLLER_BUTTON_BACK */
    {OffsetControllerImageX(260), OffsetControllerImageY(151), 0.0, MARKER_BUTTON}, /* SDL_CONTROLLER_BUTTON_GUIDE */
    {OffsetControllerImageX(323), OffsetControllerImageY(153), 0.0, MARKER_BUTTON}, /* SDL_CONTROLLER_BUTTON_START */
    {OffsetControllerImageX(83), OffsetControllerImageY(170), 0.0, MARKER_BUTTON},  /* SDL_CONTROLLER_BUTTON_LEFTSTICK */
    {OffsetControllerImageX(341), OffsetControllerImageY(256), 0.0, MARKER_BUTTON}, /* SDL_CONTROLLER_BUTTON_RIGHTSTICK */
    {OffsetControllerImageX(79), OffsetControllerImageY(39), 0.0, MARKER_BUTTON},   /* SDL_CONTROLLER_BUTTON_LEFTSHOULDER */
    {OffsetControllerImageX(418), OffsetControllerImageY(39), 0.0, MARKER_BUTTON},  /* SDL_CONTROLLER_BUTTON_RIGHTSHOULDER */
    {OffsetControllerImageX(172), OffsetControllerImageY(220), 0.0, MARKER_BUTTON}, /* SDL_CONTROLLER_BUTTON_DPAD_UP */
    {OffsetControllerImageX(172), OffsetControllerImageY(270), 0.0, MARKER_BUTTON}, /* SDL_CONTROLLER_BUTTON_DPAD_DOWN */
    {OffsetControllerImageX(139), OffsetControllerImageY(245), 0.0, MARKER_BUTTON}, /* SDL_CONTROLLER_BUTTON_DPAD_LEFT */
    {OffsetControllerImageX(204), OffsetControllerImageY(245), 0.0, MARKER_BUTTON}, /* SDL_CONTROLLER_BUTTON_DPAD_RIGHT */
    {OffsetControllerImageX(83), OffsetControllerImageY(170), 270.0, MARKER_AXIS},  /* SDL_CONTROLLER_BINDING_AXIS_LEFTX_NEGATIVE */
    {OffsetControllerImageX(83), OffsetControllerImageY(170), 90.0, MARKER_AXIS},   /* SDL_CONTROLLER_BINDING_AXIS_LEFTX_POSITIVE */
    {OffsetControllerImageX(83), OffsetControllerImageY(170), 0.0, MARKER_AXIS},    /* SDL_CONTROLLER_BINDING_AXIS_LEFTY_NEGATIVE */
    {OffsetControllerImageX(83), OffsetControllerImageY(170), 180.0, MARKER_AXIS},  /* SDL_CONTROLLER_BINDING_AXIS_LEFTY_POSITIVE */
    {OffsetControllerImageX(341), OffsetControllerImageY(256), 270.0, MARKER_AXIS}, /* SDL_CONTROLLER_BINDING_AXIS_RIGHTX_NEGATIVE */
    {OffsetControllerImageX(341), OffsetControllerImageY(256), 90.0, MARKER_AXIS},  /* SDL_CONTROLLER_BINDING_AXIS_RIGHTX_POSITIVE */
    {OffsetControllerImageX(341), OffsetControllerImageY(256), 0.0, MARKER_AXIS},   /* SDL_CONTROLLER_BINDING_AXIS_RIGHTY_NEGATIVE */
    {OffsetControllerImageX(341), OffsetControllerImageY(256), 180.0, MARKER_AXIS}, /* SDL_CONTROLLER_BINDING_AXIS_RIGHTY_POSITIVE */
    {OffsetControllerImageX(103), OffsetControllerImageY(-15), 180.0, MARKER_AXIS}, /* SDL_CONTROLLER_BINDING_AXIS_TRIGGERLEFT */
    {OffsetControllerImageX(418), OffsetControllerImageY(-15), 180.0, MARKER_AXIS}, /* SDL_CONTROLLER_BINDING_AXIS_TRIGGERRIGHT */
};
...
#ifdef FRAMEBUFFER_DEVICE
static unsigned char *fbData;
#endif

SDL_Texture *
LoadBGRA(SDL_Renderer *renderer, unsigned char *data, int width, int height, int depth)
{
    SDL_Surface *temp;
    SDL_Texture *texture;

    temp = SDL_CreateRGBSurfaceFrom((void *)data, width, height, 32, width * 4, 0x00ff0000, 0x0000ff00, 0x000000ff, 0xff000000);
...
SDL_Texture *
LoadTexture(SDL_Renderer *renderer, const void *mem, int size, SDL_bool transparent)
{
    SDL_Surface *temp;
    SDL_Texture *texture;
    SDL_RWops *rw;
    ...
    rw = SDL_RWFromConstMem(mem, size);
    temp = IMG_Load_RW(rw, 1);
    if (temp == NULL)
    {
        SDL_LogError(SDL_LOG_CATEGORY_APPLICATION, "Couldn't load buffer", IMG_GetError());
        return NULL;
    }
...
WatchJoystick(SDL_Joystick *joystick)
{
    ...
    SDL_Texture *fb, *background, *button, *axis, *marker;
...
#ifdef FRAMEBUFFER_DEVICE
    fb = LoadBGRA(screen, fbData, 1280, 720, 32);
    free(fbData);
#endif

    background = LoadTexture(screen, controllermap_png, controllermap_png_len, SDL_FALSE);
    button = LoadTexture(screen, button_png, button_png_len, SDL_TRUE);
    axis = LoadTexture(screen, axis_png, axis_png_len, SDL_TRUE);
    ...
    while (!done && !s_bBindingComplete)
    {
...
#ifdef FRAMEBUFFER_DEVICE
        SDL_RenderCopy(screen, fb, NULL, NULL);
#endif
        ...
        while (SDL_PollEvent(&event) > 0)
        {
            ...
            case SDL_KEYDOWN:
                ...
                if (event.key.keysym.sym == SDLK_SPACE || event.key.keysym.sym == SDLK_VOLUMEUP)
                {
                    SetCurrentBinding(s_iCurrentBinding + 1);
                    break;
                }
...
{
    putenv("MALI_NOCLEAR=1");
#ifdef FRAMEBUFFER_DEVICE
    fbData = malloc(1280 * 720 * 4);
    FILE *f = fopen("/dev/fb0", "rb");
    fread(fbData, 102400, 36, f);
    fclose(f);
#endif
